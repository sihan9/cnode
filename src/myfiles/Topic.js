                    ...
                    this.state.data.map((item,idx)=>(
                        <div style={{width:800,overflow:'left'}} key={idx}>
                            <div className="topic-div">
                                ...
                                <a className="topic-p topic-p2" dangerouslySetInnerHTML={{__html:item.title}} href={`/#/${this.state.props.location.pathname.split('/')[2]}/details/${this.props.match.params.page}/${idx}`}></a>
